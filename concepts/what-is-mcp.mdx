...
With **[0mcp](https://0mcp.io)**, you don't need to build or host this server yourself. 0mcp hosts and manages it for you.

### Tool

A [**tool**](/learn/core-concepts/tools) performs an action.
...
A [**resource**](/learn/core-concepts/resources) is information that an AI client can read.
...
A [**prompt**](/learn/core-concepts/prompts) is a reusable instruction template that can include optional inputs.
