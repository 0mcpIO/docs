...
If [0mcp](https://0mcp.io) can't parse your API specification, the document may contain formatting errors, unsupported structures, or missing required fields.
...
<Warning>
  Do not upload a GraphQL schema through the OpenAPI source. Use the dedicated [Postman source](/api-sources/postman) for Postman Collection v2 JSON files.
</Warning>
...
Unique operation IDs help 0mcp generate clear [MCP tool names](/learn/core-concepts/tools).
