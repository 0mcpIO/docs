...
Unlike [**tools**](/learn/core-concepts/tools), which perform actions, resources simply provide information. They're ideal for documentation, policies, reference material, or other content that AI clients may need during conversations.
...
If the content requires executing business logic or retrieving live data, use a [**tool**](/learn/core-concepts/tools) instead.
