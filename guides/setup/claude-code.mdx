...
Publish a server version, then open **Setup** in [0mcp](https://0mcp.io) and select **Claude Code**. The page creates a command for your server and its authentication needs.
