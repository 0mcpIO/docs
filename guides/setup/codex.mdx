---
title: Codex
description: Connect a published 0mcp server to Codex with the generated CLI command or TOML configuration while keeping credentials in environment variables.
---

Publish a version, open **Setup**, and select **Codex**. [0mcp](https://0mcp.io) provides both a CLI command and TOML configuration.
...
<Warning>
  Do not replace your full [Codex](https://learn.chatgpt.com/docs/extend/mcp) configuration with the generated block. Merge it with your existing settings.
</Warning>
