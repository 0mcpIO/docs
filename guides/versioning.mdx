---
title: Versioning
description: Learn how 0mcp saves server configurations as versions so you can test draft changes, publish updates, and protect connected MCP clients from unfinished work.
---

Every time you make changes to your MCP server, [0mcp](https://0mcp.io) saves them as a **version**. A version is a snapshot of your server's configuration, including its [tools](/learn/core-concepts/tools), [resources](/learn/core-concepts/resources), and [prompts](/learn/core-concepts/prompts).
