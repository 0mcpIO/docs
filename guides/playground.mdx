...
The **Playground** lets you interact with your published MCP server through a chat interface. It's the fastest way to verify that your [tools](/learn/core-concepts/tools), [resources](/learn/core-concepts/resources), and [prompts](/learn/core-concepts/prompts) behave as expected before using them in applications like Claude Code or Cursor.
...
- [0mcp](https://0mcp.io) does not store Playground credentials, request payloads, or response payloads as activity data.
