...
0mcp accepts OpenAPI 3.x and Swagger 2.0 in JSON or YAML. You can upload a file, paste the document, or provide a public URL. You can also convert a [direct REST API](/api-sources/rest-api) or [GraphQL API](/api-sources/graphql) into an MCP server. Postman Collection import is planned.
