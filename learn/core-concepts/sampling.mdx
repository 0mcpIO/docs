...
**[MCP sampling](https://modelcontextprotocol.io/specification/2025-11-25/client/sampling)** lets an MCP server request a language-model generation through the MCP client.
