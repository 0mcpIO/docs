...
A **custom [MCP transport](https://modelcontextprotocol.io/specification)** changes how MCP messages move between a client and server while preserving the protocol's JSON-RPC messages and lifecycle.
