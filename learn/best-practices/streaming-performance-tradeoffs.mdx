...
For current remote servers, the standard transport is **[Streamable HTTP](https://modelcontextprotocol.io/specification/2025-11-25/basic/transports)**. Local process integrations commonly use **stdio**.
...
The MCP `2025-11-25` specification introduced tasks as an experimental feature for tracking deferred results through polling.
