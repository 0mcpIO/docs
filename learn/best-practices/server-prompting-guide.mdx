...
**[MCP server prompting](https://modelcontextprotocol.io/specification/2025-11-25/server/prompts)** includes the words your server uses to explain its capabilities to an AI client. This can include tool descriptions, resource metadata, reusable prompts, and optional server instructions.
