...
description: Import an OpenAPI 3.x or Swagger 2.0 document into 0mcp, review the generated MCP tools, configure authentication, and publish a hosted MCP server.
---

[0mcp](https://0mcp.io) generates MCP tools directly from your **OpenAPI** specification. Simply import your API definition, review the generated tools, and publish your MCP server.

Currently, 0mcp supports:

- **[OpenAPI](https://spec.openapis.org/oas/latest.html) 3.x**
- **Swagger 2.0**
...
- Choose which operations become [MCP tools](/learn/core-concepts/tools)
